...
class Laundry extends CI_Controller
{
	...
	public function getData()
	{
		...
		foreach ($results as $r) {
			...
			if ($r->status == 'proses') {
				$btn_prosses = "<a href='#' class='btn btn-sm btn-outline-info' onclick='processOrder(" . $r->id . ", \"cuci\")'>Proses</a> ";
			} elseif ($r->status == 'cuci') {
				$btn_prosses = "<a href='#' class='btn btn-sm btn-outline-primary' onclick='processOrder(" . $r->id . ", \"kering\")'>Kering</a> ";
			} elseif ($r->status == 'kering') {
				$btn_prosses = "<a href='#' class='btn btn-sm btn-outline-warning' onclick='processOrder(" . $r->id . ", \"belum_diambil\")'>Belum Diambil</a> ";
			} elseif ($r->status == 'belum_diambil') {
				$btn_prosses = "<a href='#' class='btn btn-sm btn-outline-success' onclick='processOrder(" . $r->id . ", \"diambil\")'>Diambil</a> ";
			} else {
				$btn_prosses = "";
			}
			$data[] = [
